...
import ibm_db
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=824dfd4d-99de-440d-9991-629c01b3832d.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=30119;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=qmn10198;PWD=JUJj5Nh2XrpV0u5V;AUTHENTICATION=SERVER;",'','')
...
@app.route('/')
def index():
    return render_template('home.html')      # index - home page
...
@app.route('/contact')
def adminreg():
  return render_template('contact.html')  # admin sign up page


@app.route('/aboutus')
def recipregistration():
  return render_template('aboutus.html')   ## recipient signup page 
